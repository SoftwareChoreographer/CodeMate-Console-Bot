...
public class CodeMate{
    ...
    public static void main(String[] args){
        ...
        while(running){
            ...
            switch (choice){
                case 1: ageGuessService.guessAge(scanner, userName); break;
                case 2: countingService.countNumbers(scanner, userName); break;
                case 3: quizService.runQuiz(scanner, userName); break;
